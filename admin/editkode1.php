...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        include "koneksi.php";
        $no=$_GET['no'];
        $datad = mysqli_query($koneksi,"select * from kode1 where no='$no'");
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                ...
                                                <button type="submit" name="editkode1" class="btn mb-1 btn-flat btn-outline-primary"></i>Simpan</button>
                                                <a href="kode.php">
    ...
    ***********************************-->
    ...
    if(isset($_POST['editkode1']))
    {
        ...
        mysqli_query($koneksi,"update kode1 set 
            kode='$kode',
            arti='$arti'
            where no='$no'");
