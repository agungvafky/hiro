                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Pengaturan Pengguna</h4>
                                    <p align="right">
                                    <a href="tambahpengaturan.php">
                                        <button type="button" class="btn mb-1 btn-flat btn-outline-primary" >Tambah</button>
                                    </a>
                                    </p>
                                <div class="table-responsive">
                                    ...
                                    <tfoot>
                                      ...
                                      include "koneksi.php";
                                      $no=1;
                                      $datad = mysqli_query($koneksi,"select * from pengguna");
