...
<div class="row">
                                    ...
                                    <?php } ?>
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" name="ukuran" id="ukuran" onchange="ukurand()">
                                                        <option disabled="" selected="">--Pilih disini--</option>
                                                        <?php
                                                        $datad = mysqli_query($koneksi,"select * from ukuran");
                                                        while($data = mysqli_fetch_array($datad))
                                                         { ?>
                                                        <option value="<?php echo $data['nilai'];?>"><?php echo $data['nilai2'];?></option>
                                                        <?php } ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="jumlah" id="jumlah" onmouseleave="beli()">
                                            </div>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                               ...
                               <form method="post" id="formAdd">
                                    ...
                                    <table class="table">
                                      ...
                                      ?>
                                            ...
                                            <tr>
                                                ...
                                                <td> <input type="text" class="form-control" name="tbayar" id="tbayar" onkeyup="baya()"  style="height:5px; width:150px"; ></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5">Kembalian</td>
                                                <td> <input type="text" class="form-control" name="kembali" id="kembali"  style="height:5px; width:150px"; ></td>
                                            </tr>
                                ...
                                <br>
                                <a href="laporanpembelian1.php?no_nota=<?php echo $no_nota ?>&&tbayar=<?php echo $_POST['tbayar'] ?>&&kembali=<?php echo$_POST['kembali'] ?>" target="_blank">
                    ...
                    if (isset($_POST['simpan']))
                       ...
                       <?php ; }
                        ...
                        $kurang_qty = $qty - $jumlah ;

                        $datadn = mysqli_query($koneksi,"select max(no) as jumn from item_pembelian");
                        $datan = mysqli_num_rows($datadn);
                            if($datan < 0){
                                $no = 1 ;
                            }
                            else{
                                $data2 = mysqli_fetch_array($datadn);
                                $no = $data2['jumn'] + 1;
                            }
                        ...
                        mysqli_query($koneksi, "insert into item_transaksi VALUES ('$no_nota', '$kode_barang', '$nama_barang', '$jumlah', '$harga_jual', '$diskon', '$bayar', '$tanggal')");
                         ...
                         mysqli_query($koneksi, "insert into item_pembelian VALUES ('$no', '$no_nota', '$kode_barang', '$kurang_qty')");
